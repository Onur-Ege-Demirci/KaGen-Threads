...
#ifdef __MTA__
    #include "kagen/generators/rmat/graph500/mod_arith_xmt.h"
#else
    #ifdef FAST_64BIT_ARITHMETIC
        #include "kagen/generators/rmat/graph500/mod_arith_64bit.h"
    #else
        #include "kagen/generators/rmat/graph500/mod_arith_32bit.h"
    #endif
#endif
