...
struct PGeneratorConfig {
    ...
    GraphRedistribution redistribution =
        GraphRedistribution::BALANCE_VERTICES; // experimental feature: not all generators support all distribution
                                               // types and may resort to fall-back or fail when called with unsupported
                                               // distribution types
